...
var routines = [
    new routine_1.Routine(1, 'Chest & Calves', [
    ...
    new routine_1.Routine(2, 'Back & Abs', [
    ...
    new routine_1.Routine(3, 'Shoulders & Calves', [
    ...
    ]), new routine_1.Routine(4, 'Upper Body & Abs', [
        ...
        new lift_1.Lift(3, 'Ab Circuits')
    ]), new routine_1.Routine(5, 'Legs and Shoulders', [
